...
|---------|--------|-----------|
| `Entrega 3/README.md` | Creado | Este archivo |
| `Entrega 3/SBOM_REPORT.md` | Creado | Documentacion de generacion SBOM |
| `Entrega 3/VULNERABILITY_PATCHING.md` | Creado | Reporte de remediacion de vulnerabilidades |
| `Entrega 3/SECRET_PROTECTION.md` | Creado | Documentacion del pre-commit hook |
| `Entrega 3/sbom/bom.json` | Creado | SBOM CycloneDX JSON |
| `Entrega 3/sbom/bom.xml` | Creado | SBOM CycloneDX XML |
| `Entrega 3/vulnerability-scan/*` | Creado | 8 reportes (Trivy + npm audit, before/after) |
...
### D4: socket.io v3 → v4 como segunda remediacion
...
ls Entrega\ 3/sbom/bom.json

# 2. Verificar reportes before/after
ls Entrega\ 3/vulnerability-scan/
